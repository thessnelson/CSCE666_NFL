...
plt.title("Feature Importance on Game Data", fontdict={'fontsize': 34})
plt.show()
plt.close()
...
plt.rc('ytick', labelsize=24)
plt.barh(names[sorted_idx], clf.feature_importances_[sorted_idx], color= colors[sorted_idx])
plt.title("Feature Importance on Rolling Season Average", fontdict={'fontsize': 34})
plt.show()
plt.close()
'''
...
file = open('D:\School\Fall 22\Pattern Analysis\CSCE666_NFL\\results\\acc_dd_n', 'wb')
pickle.dump(acc_dd, file)
file.close()

file = open('D:\School\Fall 22\Pattern Analysis\CSCE666_NFL\\results\\acc_ss_n', 'wb')
pickle.dump(acc_ss, file)
file.close()

file = open('D:\School\Fall 22\Pattern Analysis\CSCE666_NFL\\results\\acc_ds_n', 'wb')
pickle.dump(acc_ds, file)
file.close()

file = open('D:\School\Fall 22\Pattern Analysis\CSCE666_NFL\\results\\acc_ds4_n', 'wb')
pickle.dump(acc_ds4, file)
file.close()

file = open('D:\School\Fall 22\Pattern Analysis\CSCE666_NFL\\results\\acc_ds12_n', 'wb')
